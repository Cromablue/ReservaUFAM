    ...
    <div className="max-w-4xl mx-auto p-6">
      <div className="absolute left-5 top-20">
        <Link
          ...
          className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded transition-colors duration-300 shadow-md"
        >
          <svg
          ...
          <div className="grid grid-cols-1 gap-6">
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 gap-4">
                <p>
                  <span className="font-medium">Solicitante:</span> {reservation.user?.username}
                </p>
                <p>
                  <span className="font-medium">Status Atual:</span> {reservation.status}
                </p>
                <p>
                  <span className="font-medium">Data Inicial:</span>{" "}
                  {new Date(reservation.initial_date).toLocaleDateString()}
                </p>
                <p>
                  <span className="font-medium">Data Final:</span>{" "}
                  {new Date(reservation.final_date).toLocaleDateString()}
                </p>
                <p>
                  <span className="font-medium">Hora Inicial:</span> {reservation.initial_time}
                </p>
                <p>
                  <span className="font-medium">Hora Final:</span> {reservation.final_time}
                </p>
              </div>
              <div className="mt-4">
